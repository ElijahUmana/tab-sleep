...
export const RECOVERY_MANIFEST_KEY = "recoveryManifest";
export const SESSIONS_SCHEMA_VERSION_KEY = "sessionsSchemaVersion";
export const SESSIONS_SNAPSHOT_ALARM_NAME = "tab-sleep-session-snapshot-v1";
export const SESSION_SNAPSHOT_DEBOUNCE_MS = 60_000;
export const SESSION_SNAPSHOT_INTERVAL_MS = 10 * 60_000;
export const SESSION_HISTORY_LIMIT = 500;
export const SESSION_NAME_MAX_LENGTH = 80;
export const SESSIONS_IMPORT_MAX_BYTES = 50_000_000;
...
// Bump when the shape of session/history/recovery records changes and add a
// migration branch in lib/sessions.js migrateSessionsStorage().
